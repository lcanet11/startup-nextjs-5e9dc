...
<>
  ...
  <div data-custom-class="body">
    ...
    <div align="center" style={{ textAlign: "left" }}>
      ...
      >
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    <bdt className="question noTranslate">Delaware</bdt>,{" "}
                    <bdt className="question noTranslate">United States</bdt>
                  </span>
                </span>
                <bdt className="statement-end-if-in-editor" />
                <bdt className="block-component" />
        ...
        <bdt className="question noTranslate">
          1201 N. Orange Street, Suite 762
        </bdt>
        <bdt className="block-component" />,{" "}
        <bdt className="question noTranslate">Wilmington</bdt>
            ...
            <span style={{ fontSize: 15 }}>
              <span data-custom-class="body_text">
                <span style={{ color: "rgb(89, 89, 89)" }}>
                  <bdt className="block-component" />
                  <bdt className="block-component" />,{" "}
                  <bdt className="question noTranslate">DE</bdt>
                  <bdt className="statement-end-if-in-editor" />
                  <bdt className="block-component" />
                  <bdt className="block-component" />{" "}
                  <bdt className="question noTranslate">19801</bdt>
                  <bdt className="statement-end-if-in-editor" />
                </span>
              </span>
            </span>
    ...
    <div align="center" style={{ textAlign: "left" }}>
      ...
      >
        <bdt className="question">
          We provide a parking assistant service to help you communicate with
          other drivers.{" "}
        </bdt>
      </div>
      <div
      ...
      >
        ...
        >
          ...
          phone at <bdt className="question">8455390289</bdt>, email at{" "}
          <bdt className="question noTranslate">
            <a
              target="_blank"
              data-custom-class="link"
              href="mailto:info@dartcoop.com"
            >
              info@dartcoop.com
            </a>
          </bdt>
      ...
      >
        ...
        >
          ...
          <bdt className="question noTranslate">Dart Consulting Corp</bdt>,
    ...
    <div align="center" style={{ textAlign: "left" }}>
      ...
      <div className="MsoNormal" style={{ lineHeight: "1.5" }}>
        ...
        <a data-custom-class="link" href="#subscriptions">
          <span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>
            <span data-custom-class="body_text">7. SUBSCRIPTIONS</span>
          </span>
        </a>
        <bdt className="statement-end-if-in-editor">
          <span style={{ fontSize: 15 }} />
      ...
      <div className="MsoNormal" style={{ lineHeight: "1.5" }}>
        ...
        <a data-custom-class="link" href="#returnno">
          <span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>
            <span data-custom-class="body_text">
              8. <bdt className="block-component" />
              RETURN
      ...
      <div className="MsoNormal" style={{ lineHeight: "1.5" }}>
        <span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>
          <a data-custom-class="link" href="#sms">
            <span data-custom-class="body_text">25. SMS TEXT MESSAGING</span>
          </a>
        </span>
        <bdt className="statement-end-if-in-editor">
          <span style={{ fontSize: 15 }} />
      ...
      >
        ...
        >
          ...
          <span style={{ fontSize: 15 }}>
            ...
            <bdt className="block-component" />
            colors
            <bdt className="statement-end-if-in-editor" /> and details of the
            products. <bdt className="statement-end-if-in-editor" />
            ...
            to discontinue any products at any time for any reason. Prices for
    ...
    <div align="center" style={{ textAlign: "left" }}>
      ...
      >
        ...
        >
          ...
          <bdt className="question noTranslate">Visa</bdt>
        </span>
      </div>
      <div
        className="MsoNormal"
      ...
      >
        ...
        >
          <bdt className="forloop-component" />- &nbsp;
          <bdt className="question noTranslate">Mastercard</bdt>
        </span>
      </div>
      <div
        className="MsoNormal"
      ...
      >
        ...
        >
          <bdt className="forloop-component" />- &nbsp;
          <bdt className="question noTranslate">American Express</bdt>
        </span>
      </div>
      <div
        className="MsoNormal"
      ...
      >
        ...
        >
          <bdt className="forloop-component" />- &nbsp;
          <bdt className="question noTranslate">Discover</bdt>
        </span>
      </div>
      <div
        className="MsoNormal"
      ...
      >
        ...
        >
          <bdt className="forloop-component" />- &nbsp;
          <bdt className="question noTranslate">PayPal</bdt>
        </span>
      </div>
      <div
        className="MsoNormal"
    ...
    <div align="center" style={{ textAlign: "left", lineHeight: "1.5" }}>
      ...
      >
        <span style={{ fontSize: 15 }}>
          We offer a <bdt className="question">365</bdt>-day free trial to new
    ...
    >
      ...
      >
        ...
        >
          <bdt className="block-component" />
          the <bdt className="question noTranslate">United States</bdt>
          <bdt className="block-component" />
        </span>
    ...
    >
      ...
      <span style={{ fontSize: 15 }}>
        ...
        <bdt className="question noTranslate">Bronx</bdt>,{" "}
        <bdt className="statement-end-if-in-editor" />
        <bdt className="block-component" />
        <bdt className="question noTranslate">New York</bdt>
    ...
    >
      ...
      <bdt className="question noTranslate" style={{ fontSize: 15 }}>
        New York
      </bdt>
      <bdt className="statement-end-if-in-editor" style={{ fontSize: 15 }} />
      <span style={{ fontSize: 15 }}>
    ...
    >
      <span style={{ fontSize: 15 }}>
        By opting into any <bdt className="question noTranslate">dblPark</bdt>{" "}
        text messaging program, you expressly consent to receive text messages
        (SMS) to your mobile number.{" "}
        <bdt className="question noTranslate">dblPark</bdt> text messages may
    ...
    >
      <span style={{ fontSize: 15 }}>
        ...
        <bdt className="question">8455390289</bdt>
    ...
    >
      <span style={{ fontSize: 15 }}>
        <span style={{ color: "rgb(89, 89, 89)" }}>
          <bdt className="question noTranslate">
            <strong>Dart Consulting Corp</strong>
          </bdt>
          <strong>
            <bdt className="block-component" />
          </strong>
        ...
        <strong>
          <strong>
            ...
            >
              <strong>
                <bdt className="block-component" />
                Phone: <bdt className="question">8455390289</bdt>
                <bdt className="statement-end-if-in-editor" />
              </strong>
            </span>
          </strong>
